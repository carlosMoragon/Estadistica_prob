...
#diferencia de print, cat y paste

#print solo te imprime una variable
#cat puedes imprimir mas, y con saltos de linea etc
#paste lo que hace es pegar varibles no te imprime
